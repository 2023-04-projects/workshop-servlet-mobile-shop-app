	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (mobileList.isEmpty()) {
			...
			for (MobileForm mobile : mobileList) {
				...
				sb.append("<td><a href='stockmodifyservlet?model=").append(mobile.getProductModel()).append("'>")
						.append(mobile.getProductModel()).append("</a></td>");
				sb.append("<td>").append(mobile.getProductPrice()).append("</td>");
